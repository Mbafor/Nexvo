...
  return (
    <BlogLayout 
      title="Career Insights & Resume Tips | Blog"
      description="Expert advice on CV writing, interview preparation, and career development."
    >
...
                Latest Insights & <span className="text-blue-700">Career Advice</span>
              </h1>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Discover expert tips, industry trends, and practical guides to help you land your dream job and advance your career.
              </p>
            </div>
...
                Found {searchResults.totalCount} articles
              </p>
            </div>
          )}
...
                    Showing {searchResults.totalCount} articles
...
              Get the latest career advice and resume tips delivered directly to your inbox.
            </p>
