      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition">
              <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden border-2 border-purple-600">
                <img src="https://via.placeholder.com/150" alt="Emily Wong" className="w-full h-full object-cover" />
              </div>
              <h3 className="font-bold text-gray-900 text-lg mb-1">Emily Wong</h3>
              <p className="text-sm text-gray-600 mb-2">Head of Marketing</p>
              <p className="text-gray-700 text-sm">
                Emily drives growth and brand strategy, connecting professionals to the tools they need to succeed.
              </p>
            </div>
          </div>
        </div>
