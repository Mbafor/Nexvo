...
  if (!post) {
    return (
      <BlogLayout title="Blog Post Not Found">
...
              </svg>
            </div>
            <h1 className="text-2xl font-medium text-gray-900 mb-4">Blog Post Not Found</h1>
...
                  {/* Render JSX content directly if it's a React element, otherwise use dangerouslySetInnerHTML */}
                  {React.isValidElement(post.content.body) 
                    ? post.content.body 
                    : <div dangerouslySetInnerHTML={{ __html: typeof post.content.body === 'string' ? post.content.body : '' }} />
                  }
                </div>
