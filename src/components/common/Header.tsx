...
import LanguageSelector from "../LanguageSelector"; // <-- IMPORT ADDED
...
        
        {/* 1. Logo (Always Left) */}
        <Link to="/" className="text-2xl font-medium text-blue-700 z-50 relative">
          QuickCV
        </Link>
...
          )}
 ...
 {/* Language Selector (Placed before Sign In button) */}
          <LanguageSelector /> 
        </div>
...
      {/* Full Screen Mobile Menu Overlay (Kept same) */}
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
...
            <div className="mt-auto p-6 border-t border-gray-100 bg-gray-50 flex-shrink-0"> {/* Removed pb-8 */}
