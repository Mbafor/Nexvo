      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[60] bg-white flex flex-col h-[100dvh]" // h-[100dvh] fixes mobile browser bar issues
          >
            ...
            <div className="mt-auto p-6 border-t border-gray-100 bg-gray-50 pb-8 flex-shrink-0">
