  ...
  return (
    <nav className="sticky top-0 z-50 backdrop-blur-xl bg-white/95 border-b border-gray-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        {/* Logo */}
        <Link to="/" className="text-2xl font-medium text-blue-700">
          QuickCV
        </Link>

        {/* Desktop Menu */}
        <div className="hidden md:flex items-center space-x-6">
          <a href="/#templates" onClick={(e) => handleNavClick(e, "templates")} className="hover:text-blue-700">
            {t('header.nav.templates')}
          </a>
          <a href="/#why-choose-us" onClick={(e) => handleNavClick(e, "why-choose-us")} className="hover:text-blue-700">
          ...
          {onSignIn && (
            <button onClick={onSignIn} className="px-6 py-2 font-medium bg-blue-700 hover:bg-blue-600 text-white rounded-xl flex items-center space-x-2">
        ...
        <div className="md:hidden flex items-center space-x-2">
          ...
          <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="p-2 rounded-xl">
